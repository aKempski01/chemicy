...
from chemicy.search.dialogs.user_state import UserState
            ...
            rx.dialog.description(
                rx.flex(
                    rx.card(
                        ...
                        rx.heading("Wydział", size="3"),
                        rx.text(UserState.user.faculty),
                        rx.heading("Katedra", size="3"),
                        rx.text(UserState.user.department),
                        width="50%"
                    ),
                    rx.card(
                        ...
                        rx.text(UserState.user.office_room),
                        width = "50%"
                    ),
                    spacing="2",
                    direction="row",
